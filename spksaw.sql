...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2025 at 01:22 AM
...
--
-- Table structure for table `backup_data_warga`
--
...
--
-- Dumping data for table `backup_data_warga`
--
...
--
-- Table structure for table `backup_tbl_hasil_saw`
--
...
--
-- Dumping data for table `backup_tbl_hasil_saw`
--
...
--
-- Table structure for table `backup_tbl_klasifikasi`
--
...
--
-- Dumping data for table `backup_tbl_klasifikasi`
--
...
--
-- Dumping data for table `tbl_hasil_mfep`
--
...
--
-- Indexes for table `backup_data_warga`
--
ALTER TABLE `backup_data_warga`
  ADD PRIMARY KEY (`id_warga`),
  ADD UNIQUE KEY `idx_nama_lengkap` (`nama_lengkap`);

--
-- Indexes for table `backup_tbl_hasil_saw`
--
ALTER TABLE `backup_tbl_hasil_saw`
  ADD PRIMARY KEY (`id_hasil`),
  ADD KEY `idx_id_warga` (`id_warga`),
  ADD KEY `idx_ranking` (`ranking`);

--
-- Indexes for table `backup_tbl_klasifikasi`
--
ALTER TABLE `backup_tbl_klasifikasi`
...
--
-- Indexes for table `tbl_hasil_mfep`
--
...
ALTER TABLE `tbl_kriteria`
  ...
  ADD UNIQUE KEY `idx_kode_kriteria` (`kode_kriteria`);
...
--
-- AUTO_INCREMENT for table `backup_data_warga`
--
ALTER TABLE `backup_data_warga`
  MODIFY `id_warga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `backup_tbl_hasil_saw`
--
ALTER TABLE `backup_tbl_hasil_saw`
  MODIFY `id_hasil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `backup_tbl_klasifikasi`
--
ALTER TABLE `backup_tbl_klasifikasi`
...
--
-- AUTO_INCREMENT for table `tbl_hasil_mfep`
--
ALTER TABLE `tbl_hasil_mfep`
...
--
-- Constraints for table `tbl_hasil_mfep`
--
ALTER TABLE `tbl_hasil_mfep`
...
--
-- Constraints for table `tbl_himpunan`
--
ALTER TABLE `tbl_himpunan`
...
--
-- Constraints for table `tbl_log_bobot`
--
ALTER TABLE `tbl_log_bobot`
