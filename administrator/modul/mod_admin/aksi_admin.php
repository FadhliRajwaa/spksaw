...
if ($module=='admin' AND $act=='input_admin'){
  ...
  mysqli_query($koneksi, "INSERT INTO admin(username,
                                 password,
                                 nama_lengkap,
                                 alamat,
                                 email, 
...
elseif ($module=='admin' AND $act=='input_pengajar'){
  ...
  $cek_nip = mysqli_query($koneksi, "SELECT * FROM pengajar WHERE kodedosen='$_POST[kodedosen]'");
  ...
  if (empty($ketemu)){
      //apabila ada foto yang di upload
        ...
        $pass=md5($_POST['password']);
        $tgl_lahir=$_POST['thn'].'-'.$_POST['bln'].'-'.$_POST['tgl'];
        mysqli_query($koneksi, "INSERT INTO pengajar(kodedosen,
                                 nama_lengkap,
                                 username_login,
                                 password_login,
                                 alamat,
...
elseif ($module=='admin' AND $act=='update_pengajar'){
  ...
  $cek_nip = mysqli_query($koneksi, "SELECT * FROM pengajar WHERE id_pengajar = '$_POST[id]'");
  ...
  elseif(!empty($lokasi_file) AND empty($_POST['password'])){
      if (file_exists($direktori_file)){
            ...
            window.location=(href='../../media_admin.php?module=admin&act=pengajar')</script>";
                ...
                $cek = mysqli_query($koneksi, "SELECT * FROM pengajar WHERE id_pengajar = '$_POST[id]'");
                ...
                UploadImage($nama_file);
                mysqli_query($koneksi, "UPDATE pengajar SET kodedosen  = '$_POST[kodedosen]',
                                  nama_lengkap   = '$_POST[nama_lengkap]',
                                  username_login = '$_POST[username]',
                                  alamat         = '$_POST[alamat]',
                                  tempat_lahir   = '$_POST[tempat_lahir]',
  ...
  elseif($_POST['nip']!= $ketemu['nip']){
      $cek_nip = mysqli_query($koneksi, "SELECT * FROM pengajar WHERE nip = '$_POST[nip]'");
      ...
      if(empty($c)){
        ...
        elseif(!empty($lokasi_file) AND empty($_POST[password])){
             if (file_exists($direktori_file)){
                ...
                UploadImage($nama_file);
                mysqli_query($koneksi, "UPDATE pengajar SET nip  = '$_POST[nip]',
                                  nama_lengkap   = '$_POST[nama_lengkap]',
                                  username_login = '$_POST[username]',
                                  alamat         = '$_POST[alamat]',
                                  tempat_lahir   = '$_POST[tempat_lahir]',
...
elseif ($module=='admin' AND $act=='update_admin'){
  if (empty($_POST[password])) {
    mysqli_query($koneksi, "UPDATE admin SET username       = '$_POST[username]',
                                  nama_lengkap   = '$_POST[nama_lengkap]',
                                  alamat         = '$_POST[alamat]',
                                  email          = '$_POST[email]',
                                  no_telp        = '$_POST[no_telp]',
...
elseif ($module=='admin' AND $act=='update_pengajar2'){
  ...
  elseif($_POST['nip']!= $ketemu['nip']){
      $cek_nip2 = mysqli_query($koneksi, "SELECT * FROM pengajar WHERE nip = '$_POST[nip]'");
