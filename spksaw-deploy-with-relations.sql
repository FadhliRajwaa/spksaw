...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2025 at 10:00 AM
-- Server version: 10.4.32-MariaDB-log
-- PHP Version: 8.2.12
-- 
-- VERSION: Complete deployment with foreign key relationships
-- FEATURES: All tables with proper relational integrity
...
-- Note: Created first to be referenced by other tables
--
...
-- Note: Orphaned data removed for clean foreign key relationships
--
...
-- Note: Only valid data with existing id_kriteria references included
--

-- No orphaned data inserted to maintain referential integrity
...
-- Added for referential integrity and data consistency
--
